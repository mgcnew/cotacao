...
/**
 * A matriz de comparação: item nas linhas, fornecedor nas colunas.
 *
 * Desenhada uma vez e usada nos dois embrulhos — a página `/compras/[id]/
 * comparacao` e a mesma URL interceptada por cima da lista. Recebe os dados
 * prontos porque quem os busca é o `carregarComparacao`, e assim o modal e a
 * página não podem divergir.
 *
 * A tabela rola de lado por dentro, com a coluna do item fixa: com seis
 * fornecedores ela não cabe em tela nenhuma, e cortar coluna aqui seria
