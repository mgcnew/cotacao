  ...
  return (
    <div className="relative">
      ...
      >
        ...
        {unreadCount > 0 ? (
          <span className="bg-primary-solid text-primary-solid-fg absolute -top-0.5 -right-0.5 grid min-w-4 place-items-center rounded-full px-1 text-[10px] font-semibold tabular-nums">
